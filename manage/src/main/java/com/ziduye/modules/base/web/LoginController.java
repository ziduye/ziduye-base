...
//		}
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		// 如果已登录，再次访问主页，则退出原账号。
		if (Const.TRUE.equals(Global.getConfig("notAllowRefreshIndex"))){
	...
	public static boolean isValidateCodeLogin(String useruame, boolean isFail, boolean clean){
		Map<String, Integer> loginFailMap = (Map<String, Integer>)CacheUtils.getUserCache("loginFailMap");
		if (loginFailMap==null){
			loginFailMap = Maps.newHashMap();
			CacheUtils.putUserCache("loginFailMap", loginFailMap);
		}
