...
function(a) {
    a.widget("ui.chatbox", {
        "options": {
            ...
            "boxManager": {
                ...
                "addMsg": function(b, c) {
                    ...
                    d._scrollToBottom(),
                    d.elem.uiChatboxTitlebar.hasClass("ui-state-focus") || d.highlightLock || (d.highlightLock = !0, d.highlightBox())
                },
                "highlightBox": function() {
                    var a = this;
                    a.elem.uiChatboxTitlebar.effect("highlight", {},
                    300),
        ...
        "_create": function() {
            ...
            j = ((b.uiChatboxLog = b.element).addClass("ui-widget-content ui-chatbox-log custom-scroll").appendTo(i), (b.uiChatboxInput = a("<div></div>")).addClass("ui-widget-content ui-chatbox-input").click(function() {}).appendTo(i)),
...
function(a) {
    a.fn.emoticonize = function(b) {
        ...
        h = new RegExp("(\\" + d.join("|\\") + ")", "g"), i = "(^|[\\s\\0])", j = e.length - 1; j >= 0; --j) e[j] = e[j].replace(h, "\\$1"),
        e[j] = new RegExp(i + "(" + e[j] + ")", "g");
        for (var j = f.length - 1; j >= 0; --j) f[j] = f[j].replace(h, "\\$1"),
        ...
        return this.not(l).each(function() {
            ...
            for (var h in g) specialCssClass = d + " " + g[h].cssClass,
