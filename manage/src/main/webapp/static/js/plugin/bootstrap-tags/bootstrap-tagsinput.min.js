...
function(a) {
    ...
    b.prototype = {
        ...
        "remove": function(b, c) {
            var d = this;
            d.objectItems && (b = "object" == typeof b ? a.grep(d.itemsArray,
            function(a) {
                return d.options.itemValue(a) == d.options.itemValue(b)
            })[0] : a.grep(d.itemsArray,
            function(a) {
            ...
            b && (a(".tag", d.$container).filter(function() {
                ...
                return a(this).data("item") === b
            }).remove(), d.itemsArray.splice(a.inArray(b, d.itemsArray), 1)),
            c || d.pushVal(),
        ...
        "build": function(b) {
            ...
            h.source && a.fn.typeahead && (d(h, "source"), e.$input.typeahead({
                "source": function(b, c) {
                    function d(a) {
