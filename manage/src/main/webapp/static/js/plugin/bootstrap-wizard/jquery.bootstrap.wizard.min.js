...
function(a) {
    var b = function(b, c) {
        ...
        f = a.extend({},
        a.fn.bootstrapWizard.defaults, c),
        g = null,
        h = null;
        ...
        this.fixNavigationButtons = function() {
            return g.length || (h.find("a:first").tab("show"), g = h.find(e + ":first")),
            a(f.previousSelector, b).toggleClass("disabled", d.firstIndex() >= d.currentIndex()),
            a(f.nextSelector, b).toggleClass("disabled", d.currentIndex() >= d.navigationLength()),
            ...
            f.onTabShow && "function" == typeof f.onTabShow && f.onTabShow(g, h, d.currentIndex()) === !1 ? !1 : void 0
        },
        this.next = function() {
        ...
        f.onShow && "function" == typeof f.onShow && f.onShow(g, h, d.nextIndex()),
        d.fixNavigationButtons(),
        a('a[data-toggle="tab"]', h).on("click",
        function(b) {
        ...
        a('a[data-toggle="tab"]', h).on("shown shown.bs.tab",
        function(b) {
    ...
    a.fn.bootstrapWizard = function(c) {
        if ("string" == typeof c) {
            ...
            return 1 === d.length && d.toString(),
            this.data("bootstrapWizard")[c](d)
        }
