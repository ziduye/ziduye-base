            ...
            if (!b.initialized) {
                ...
                if (b.widget.each(function() {
                    ...
                    if (!m.parent().attr("role")) {
                        ...
                        f = b.o.editButton === !0 && l.data("widget-editbutton") === d ? '<a href="javascript:void(0);" class="button-icon jarviswidget-edit-btn" rel="tooltip" title="Edit" data-placement="bottom"><i class="' + b.editClass[0] + '"></i></a>': "",
