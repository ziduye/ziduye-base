...
var demohtml = 
	...
	+'	<form>'
	+'		<legend class="no-padding margin-bottom-10">布局选项</legend>'
	+'		<section>'
	+'			<label><input name="subscription" id="smart-fixed-header" type="checkbox" class="checkbox style-0"><span>固定页头</span></label>'
	+'			<label><input type="checkbox" name="terms" id="smart-fixed-navigation" class="checkbox style-0"><span>固定导航条</span></label>'
	+'			<label><input type="checkbox" name="terms" id="smart-fixed-ribbon" class="checkbox style-0"><span>固定导航菜单</span></label>'
	+'			<label><input type="checkbox" name="terms" id="smart-fixed-footer" class="checkbox style-0"><span>固定页脚</span></label>'
	+'			<label><input type="checkbox" name="terms" id="smart-fixed-container" class="checkbox style-0"><span>固定宽度</span></label>'
	+'			<label style="display:block;"><input type="checkbox" name="terms" id="smart-rtl" class="checkbox style-0"><span>RTL支持</span></label>'
	+'			<label style="display:block;"><input type="checkbox" id="smart-topmenu" class="checkbox style-0"><span>头部菜单</span></label>'
	+'			<label style="display:block;"><input type="checkbox" id="colorblind-friendly" class="checkbox style-0"><span>色盲模式<div class="font-xs text-right">(实验)</div></span></label>'
	+'			<span id="smart-bgimages"></span>'
	+'		</section>'
	+'		<section>'
	+'			<h6 class="margin-top-10 semi-bold margin-bottom-5">清空本地存储</h6>'
	+'			<a href="javascript:void(0);" class="btn btn-xs btn-block btn-primary" id="reset-smart-widget"> <i class="fa fa-refresh"></i>部件重置</a>'
	+'		</section>'
...
$('input[type="checkbox"]#smart-fixed-header').click(function() {
    $(this).is(":checked") ? $.root_.addClass("fixed-header") : (
