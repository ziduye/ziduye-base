...
$.smallBox = function(a, b) {
    ...
    void 0 != a.timeout && setTimeout(function() {
        ...
        0 != $("#" + f + ":hover").length ? $("#" + f).on("mouseleave",
        function() {
            SmallBoxesAnchos -= a,
            $("#" + f).remove(),
            "function" == typeof b && b && b();
